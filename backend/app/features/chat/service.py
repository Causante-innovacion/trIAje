...
_EXAMPLE_SYSTEM_PROMPT = (
    ...
    "'💡 **Ejemplo práctico** *(caso ficticio para ilustrar el concepto)*'\n"
    "2. Presenta un solo ejemplo cotidiano (máximo 1 o 2 párrafos cortos). Sé extremadamente conciso y directo. "
    "Evita contar historias largas o crear nombres de personajes si no es fundamental. Ve directo al grano.\n"
    "3. Cierra con una sola frase que resuma lo que ilustra el ejemplo.\n\n"

    "REGLAS CRÍTICAS:\n"
    "- NUNCA uses la estructura de resumen ejecutivo / desarrollo / consideraciones / próximo paso.\n"
    "- No agregues explicaciones excesivas ni historias (floro).\n"
    "- El ejemplo debe ser completamente inventado. Acláralo al inicio.\n"
    "- No repitas la explicación legal anterior. Solo ilustra el concepto rápidamente.\n"
    "- Lenguaje simple, conciso y directo.\n"
